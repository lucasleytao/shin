...
(function () {
    window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function () {
        ...
        CKEDITOR.event.prototype = function () {
            ...
            function (a, e) { a in { instanceReady: 1, loaded: 1 } && (this[a] = !0); return CKEDITOR.event.prototype.fire.call(this, a, e, this) }, CKEDITOR.editor.prototype.fireOnce = function (a, e) { a in { instanceReady: 1, loaded: 1 } && (this[a] = !0); return CKEDITOR.event.prototype.fireOnce.call(this, a, e, this) }, CKEDITOR.event.implementOn(CKEDITOR.editor.prototype)), CKEDITOR.env || (CKEDITOR.env = function () {
                ...
                var a = [], e = CKEDITOR.env.gecko ? "-moz-" :
                    CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, d = /</g, k = /"/g, m = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, f = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" }, h = function (a, g) { return "#" == g[0] ? String.fromCharCode(parseInt(g.slice(1), 10)) : f[g] }; CKEDITOR.on("reset", function () { a = [] }); CKEDITOR.tools = {
        ...
        {
            enable: function () { this.state == CKEDITOR.TRISTATE_DISABLED && this.checkAllowed() && this.setState(this.preservShin && "undefined" != typeof this.previousState ? this.previousState : CKEDITOR.TRISTATE_OFF) }, disable: function () { this.setState(CKEDITOR.TRISTATE_DISABLED) }, setState: function (a) { if (this.state == a || a != CKEDITOR.TRISTATE_DISABLED && !this.checkAllowed()) return !1; this.previousState = this.state; this.state = a; this.fire("state"); return !0 }, togglShin: function () {
        ...
        CKEDITOR.htmlParser.fragment = function () { this.children = []; this.parent = null; this._ = { isBlockLike: !0, hasInlineStarted: !1 } }, function () {
            ...
            } function f(a, b) { return b ? a.replace(z, function (a, b) { return b ? " " : "" }) : a.replace(A, "") } function h(a, b) {
            ...
            }; var y = { img: 1, hr: 1, li: 1, table: 1, tr: 1, td: 1, th: 1, embed: 1, object: 1, ol: 1, ul: 1, a: 1, input: 1, form: 1, select: 1, textarea: 1, button: 1, fieldset: 1, thead: 1, tfoot: 1 }, A = CKEDITOR.tools.repeat("​",
            ...
            e) { this.requiredContent = this.allowedContent = this.style = a; CKEDITOR.tools.extend(this, e, !0) }, CKEDITOR.styleCommand.prototype.exec = function (a) { a.focus(); this.state == CKEDITOR.TRISTATE_OFF ? a.applyStyle(this.style) : this.state == CKEDITOR.TRISTATE_ON && a.removeStyle(this.style) }, CKEDITOR.stylesSet = new CKEDITOR.resourceManager("", "stylesSet"), CKEDITOR.addStylesSet = CKEDITOR.tools.bind(CKEDITOR.stylesSet.add, CKEDITOR.stylesSet), CKEDITOR.loadStylesSet = function (a, e, b) {
                ...
                attachStylShinChange: function (a, e) { var b = this._.stylShinChangeCallbacks; b || (b = this._.stylShinChangeCallbacks = [], this.on("selectionChange", function (a) { for (var d = 0; d < b.length; d++) { var e = b[d], m = e.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF; e.fn.call(this, m) } })); b.push({ style: a, fn: e }) }, applyStyle: function (a) { a.apply(this) }, removeStyle: function (a) { a.remove(this) }, getStylesSet: function (a) {
                        ...
                        var e = a.getParentEditor(),
                            g, h, k, l, m, n, p = CKEDITOR.tools.addFunction(function (d) {
                                ...
                                var b = ""; f == CKEDITOR.DIALOG_RESIZE_WIDTH ? b = " cke_resizer_horizontal" : f == CKEDITOR.DIALOG_RESIZE_HEIGHT && (b = " cke_resizer_vertical"); b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + e.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(e.lang.common.resize) +
                                    '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + p + ', event )"\x3e' + ("ltr" == e.lang.dir ? "◢" : "◣") + "\x3c/div\x3e"); a.parts.footer.append(b, 1)
        ...
        CKEDITOR.plugins.add("about", { requires: "dialog", init: function (a) { var e = a.addCommand("about", new CKEDITOR.dialogCommand("about")); e.modes = { wysiwyg: 1, source: 1 }; e.canUndo = !1; e.readOnly = 1; a.ui.addButton && a.ui.addButton("About", { label: a.lang.about.title, command: "about", toolbar: "about" }); CKEDITOR.dialog.add("about", this.path + "dialogs/about.js") } }), CKEDITOR.plugins.add("basicstyles", {
            init: function (a) {
                var e = 0, b = function (b, d, h, k) {
                    if (k) {
                        k = new CKEDITOR.style(k); var g = c[h]; g.unshift(k); a.attachStylShinChange(k,
                                ...
                                if (CKEDITOR.env.ie && 8 < CKEDITOR.env.version && e && b.editable().hasFocus) return e; if (document.body.createTextRange) {
                                    b.focus(); c = b.document.getBody().$.createTextRange(); try {
                                        for (var k = !1, l = 0; 20 > l &&
                                            !k; l++) { if (!k) try { c.moveToPoint(d, f - l), k = !0 } catch (m) { } if (!k) try { c.moveToPoint(d, f + l), k = !0 } catch (r) { } } if (k) { var w = "cke-temp-" + (new Date).getTime(); c.pasteHTML('\x3cspan id\x3d"' + w + '"\x3e​\x3c/span\x3e'); var C = b.document.getById(w); h.moveToPosition(C, CKEDITOR.POSITION_BEFORE_START); C.remove() } else {
            ...
            function a(a) {
                function c(e) {
                    for (var h = u.startContainer, m = u.endContainer; h && !h.getParent().equals(e);)h = h.getParent(); for (; m && !m.getParent().equals(e);)m = m.getParent(); if (!h || !m) return !1; for (var q = h, h = [], t = !1; !t;)q.equals(m) && (t = !0), h.push(q), q = q.getNext(); if (1 > h.length) return !1; q = e.getParents(!0); for (m = 0; m < q.length; m++)if (q[m].getName && k[q[m].getName()]) { e = q[m]; break } for (var q =
                        ...
                        } h && h.listNode.replace(e); if (B && B.length) for (m = 0; m < B.length; m++) { for (D = e = B[m]; (D = D.getNext()) && D.is && D.getName() in k;)CKEDITOR.env.needsNbspFiller && !e.getFirst(b) && e.append(u.document.createText(" ")), e.append(D); e.insertAfter(x) } h && a.fire("contentDomInvalidated"); return !0
        ...
        function () {
            function a(a, b, c) {
                ...
                listToArray: function (a, b, c, d, e) {
                    ...
                    c || (c = 0); if (!a || a.length < c + 1) return null; for (var h, k = a[c].parent.getDocument(), m = new CKEDITOR.dom.documentFragment(k), n = null, u = c, v = Math.max(a[c].indent, 0), D = null, F, E, I = d == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                        ...
                        } else if (G.indent == Math.max(v, 0) + 1) G = a[u - 1].element.getDirection(1), u = CKEDITOR.plugins.list.arrayToList(a, null, u, d, G != F ? F : null), !D.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= k.$.documentMode && D.append(k.createText(" ")), D.append(u.listNode), u = u.nextIndex; else if (-1 ==
                            G.indent && !c && h) {
                            ...
                            t = k.checkEndOfBlock(), p = a.elementPath(k.startContainer), y = p.block, A = f == CKEDITOR.ENTER_DIV ? "div" : "p", z; if (q && t) {
                                ...
                                f = q.previousBlock; y = q.nextBlock; p = q.wasStartOfBlock; a = q.wasEndOfBlock; y ? (w = y.getParent(), w.is("li") && (y.breakParent(w), y.move(y.getNext(), 1))) : f && (w = f.getParent()) && w.is("li") && (f.breakParent(w), w = f.getNext(), k.moveToElementEditStart(w),
                                    f.move(f.getPrevious())); if (p || a) {
                                        ...
                                        u.createText(" ")).insertBefore(w)), y && k.moveToElementEditStart(y); k.select(); k.scrollIntoView()
                            }
                    }
            ...
            function a(a, b) {
                var c = {}, d = [], k = { nbsp: " ", shy: "­", gt: "\x3e", lt: "\x3c", amp: "\x26", apos: "'", quot: '"' }; a = a.replace(/\b(nbsp|shy|gt|lt|amp|apos|quot)(?:,|$)/g, function (a, f) { var e = b ? "\x26" + f + ";" : k[f]; c[e] = b ? k[f] : "\x26" + f + ";"; d.push(e); return "" }); if (!b && a) {
        ...
        "use strict", function () {
                        ...
                        function e() { var b = l.getViewPaneSize(); a.resize(b.width, b.height, null, !0) } if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                            var f = a.lang, h = CKEDITOR.document, l = h.getWindow(), g, n, v, u = CKEDITOR.TRISTATE_OFF; a.addCommand("maximize", {
                                modes: { wysiwyg: !CKEDITOR.env.iOS, source: !CKEDITOR.env.iOS }, readOnly: 1, editorFocus: !1, exec: function () {
                                    ...
                                    } this.togglShin(); if (p = this.uiItems[0]) t = this.state == CKEDITOR.TRISTATE_OFF ? f.maximize.maximize : f.maximize.minimize, p = CKEDITOR.document.getById(p._.id), p.getChild(1).setHtml(t), p.setAttribute("title", t), p.setAttribute("href", 'javascript:void("' + t + '");'); "wysiwyg" ==
            ...
            function a(a, c, d) { var e = CKEDITOR.cleanWord; e ? d() : (a = CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile || c + "filter/default.js"), CKEDITOR.scriptLoader.load(a, d, null, !0)); return !e } function e(a) { a.data.type = "html" } CKEDITOR.plugins.add("pastefromword", {
                requires: "clipboard", init: function (b) {
                    ...
                    }); b.ui.addButton && b.ui.addButton("PasteFromWord", { label: b.lang.pastefromword.toolbar, command: "pastefromword", toolbar: "clipboard,50" }); b.on("pastShin", function (a) { b.getCommand("pastefromword").setState(a.data) }); b.on("paste", function (e) {
            ...
            }; CKEDITOR.plugins.add("pastetext", { requires: "clipboard", init: function (e) { e.addCommand("pastetext", a); e.ui.addButton && e.ui.addButton("PasteText", { label: e.lang.pastetext.button, command: "pastetext", toolbar: "clipboard,40" }); if (e.config.forcePasteAsPlainText) e.on("beforePaste", function (a) { "html" != a.data.type && (a.data.type = "text") }); e.on("pastShin", function (a) { e.getCommand("pastetext").setState(a.data) }) } })
                        ...
                        var m = null, f, h, l = ("both" == c.resize_dir || "horizontal" == c.resize_dir) && c.resize_minWidth != c.resize_maxWidth, g = ("both" == c.resize_dir || "vertical" == c.resize_dir) && c.resize_minHeight != c.resize_maxHeight, n = CKEDITOR.tools.addFunction(function (d) {
                            ...
                            if ("bottom" == b.data.space) {
                                var c = ""; l && !g && (c = " cke_resizer_horizontal"); !l && g && (c = " cke_resizer_vertical"); var f = '\x3cspan id\x3d"' + d + '" class\x3d"cke_resizer' +
                                    c + " cke_resizer_" + k + '" title\x3d"' + CKEDITOR.tools.htmlEncode(a.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event)"\x3e' + ("ltr" == k ? "◢" : "◣") + "\x3c/span\x3e"; "ltr" == k && "ltr" == c ? b.data.html += f : b.data.html = f + b.data.html
                            }
            ...
            var a = { preservShin: !0, editorFocus: !1, readOnly: 1, exec: function (a) { this.togglShin(); this.refresh(a) }, refresh: function (a) { if (a.document) { var b = this.state == CKEDITOR.TRISTATE_ON ? "attachClass" : "removeClass"; a.editable()[b]("cke_show_borders") } } }; CKEDITOR.plugins.add("showborders", {
        ...
        function () {
            ...
            function a(a) {
                ...
                init: function (d) {
                    for (var k = !1 !== d.config.enableTabKeyTools, m = d.config.tabSpaces || 0, f = ""; m--;)f += " "; if (f) d.on("key", function (a) { 9 == a.data.keyCode && (d.insertText(f), a.cancel()) }); if (k) d.on("key", function (a) {
