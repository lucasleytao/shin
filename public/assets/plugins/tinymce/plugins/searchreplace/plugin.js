	...
	function Plugin(editor) {
		...
		function showDialog() {
			...
			var win = editor.windowManager.open({
				...
				onSubmit: function(e) {
					var count, casShin, text, wholeWord;

					e.preventDefault();

					casShin = win.find('#case').checked();
					...
					if (last.text == text && last.casShin == casShin && last.wholeWord == wholeWord) {
					...
					count = self.find(text, casShin, wholeWord);
					if (!count) {
						notFoundAlert();
					}
