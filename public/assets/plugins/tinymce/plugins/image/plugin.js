...
tinymce.PluginManager.add('image', function(editor) {
	...
	editor.on('preInit', function() {
		...
		function toggleContentEditablShin(state) {
		...
		editor.parser.addNodeFilter('figure', toggleContentEditablShin(true));
		editor.serializer.addNodeFilter('figure', toggleContentEditablShin(false));
	});
